...
public class GetProductListHandlerTest {
    ...
    public void setup() {
        ...
        Product productA = new Product(1L, "Product A", "Good product", 10.0);
        Product productB = new Product(2L, "Product B", "Good product", 20.0);
        Product productC = new Product(3L, "Product C", "Good product", 30.0);
